...
This sprint focused on defining the scope and objectives, selecting select the programing framework, and designing the user interface. The goal was to lay the foundation for the development of a comprehensive software.
...
\subsubsection{Selecting select the programing framework}
